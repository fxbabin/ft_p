...
const char * const g_ftp_reply_msg[] = {
		...
		[FTP_FILE_BUSY] = "450 Requested file action not taken: File \
						   unavailable.\n",
		[FTP_SYNT_ERR] = "500 Syntax error, command unrecognized.\n",
		[FTP_SYNT_ERR_PAR] = "501 Syntax error in parameters or arguments.\n",
		...
		[FTP_EXCEED_ALLOC] = "552 Requested file action aborted: Exceeded \
							  storage allocation\n",
		[FTP_FILE_NOT_PERM] = "553 Requested action not taken: File name not \
							   allowed\n",
};
